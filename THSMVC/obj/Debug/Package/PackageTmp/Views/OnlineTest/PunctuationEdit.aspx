    ...
    <script type="text/javascript">
        function UpdatepQuestion() {
            ...
            $.ajax({
                type: "POST",
                traditional: true,
                url: "/OnlineTest/UpdatepQuestion",
                data: {
...
<body>
    ...
    <div class="clear">
        ...
        <div id="divEditQuestion">
            <div class="clear">
                <div class="boxinline">
                    ...
                    <p>
                        <%=Html.TextBoxFor(m => m.question.ToList()[0].Question, new { name = "question", size = "60", id = "questionp" })%>
                    </p>
                </div>
                <div class="boxinline">
                    <p class="titlename">
                    ...
                    <p>
                        <%=Html.TextBoxFor(m => m.question.ToList()[0].Answer, new { name="pans",size="60",id="pans"})%>
                         <%= Html.HiddenFor(m => m.question.ToList()[0].AnswerId, new { id = "hdnAId1" })%>
                    </p>
                </div>
            </div>
        </div>
        ...
        <input type="button" class="rg_button_red" title="Save" value="Save Question" onclick="UpdatepQuestion();" />
    </div>
    <script type="text/javascript">
        webpath_img = '../images/';
