    ...
    <%= Html.HiddenFor(m => m.Test, new { id = "hdnValTestId" })%>
     ...
     <div class="clear">
        ...
        <div id="divEditQuestion">
            <div class="clear">
                <div class="boxinline">
                    ...
                    <textarea id="question" style="width: 265px; margin-bottom: 10px;" rows="3" cols="5" name="question"></textarea><br />
                </div>
                <div class="boxinline">
                    <p class="titlename">
                        <strong>Answer</strong></p>
                   <input type="radio" name="correct" value="1" id="tf1" />
                    This is correct answer<br />
                   <input type="text" name="tfans1" size="30" id="tfans1" value="True"/>
                </div>
                <div class="boxinline">
                    <p class="titlename">
                        <strong>Answer</strong></p>
                    <input type="radio" name="correct" value="2" id="tf2"  />
                    This is correct answer<br />
                    <input type="text" name="tfans2" size="30" id="tfans2" value="False"/>
                </div>
            </div>
        </div>
        ...
        <div class="boxinline">
         ...
         <input type="button" class="rg_button_red" title="Save" value="Save Question" onclick="SavetfQuestion();" />
    </div>
    <script type="text/javascript">
