...
<body>
   <div style="width: 100%;">
                ...
                <script defer="defer" type="text/javascript">
                    ...
                    var gridDataUrl = '/Admin/JsonRelationCollection';

                    jQuery("#list").jqGrid({
                        url: gridDataUrl,
                        datatype: "json",
                        mtype: 'POST',
                        colNames: ['Id', 'Instance Id', 'Instance Name', 'Relation Name', 'Short Name'],
                        colModel: [
              ...
              { name: 'RelationName', index: 'RelationName', width: 100, align: 'left', editable: true, formoptions: { elmsuffix: '(*)', rowpos: 4, colpos: 2 }, edittype: 'text', editrules: { required: true }, searchoptions: { sopt: ['eq', 'ne', 'cn']} },
              { name: 'RelationShortName', index: 'RelationShortName', width: 100, align: 'left', editable: true, edittype: 'text', editrules: { required: true }, formoptions: { elmsuffix: '(*)', rowpos: 5, colpos: 2 }, searchoptions: { sopt: ['eq', 'ne', 'cn']}}],
                        rowNum: 10,
   ...
   { closeOnEscape: true, url: "/Admin/EditJsonRelation", closeAfterEdit: false, width: 350, checkOnSubmit: false, topinfo: "Transaction Successful..", bottominfo: "Fields marked with(*) are required.", beforeShowForm: function (form) { $("#tr_InstanceId").css("display", "block"); }, afterSubmit: // Function for show msg after submit the form in edit
   ...
   {closeOnEscape: true, url: "/Admin/AddJsonRelation", closeAfterAdd: false, width: 350, topinfo: "Transaction Successful..", bottominfo: "Fields marked with(*) are required.", beforeShowForm: function (formid) { $("#tr_InstanceId", formid).show(); $("#FrmTinfo").css("display", "none"); }, afterSubmit: // Function for show msg after submit the form in Add
        function (response, postdata) {
            var json = response.responseText; //in my case response text form server is "{sc:true,msg:''}"
            if (json) {
                $("#FrmTinfo").css("display", "block");
   ...
   {url: "/Admin/DelJsonRelation", onclickSubmit: function (params) {
       var ajaxData = {};
       var list = $("#list");
