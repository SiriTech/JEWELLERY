...
<body>
      <div style="width: 100%;">
                ...
                <script defer="defer" type="text/javascript">
                    ...
                    var ClassesURL = '/Admin/JsonClasses';

                    //get all countries
                    Classes = $.ajax({ url: ClassesURL, cache: false, async: false, success: function (data, result) { if (!result) alert('Failure to retrieve the Countries.'); } }).responseText;
                    
                    var gridimgpath = '/Scripts/jqgrid/themes/redmond/images';
                    var gridDataUrl = '/Admin/JsonSectionCollection';

                    jQuery("#list").jqGrid({
                        url: gridDataUrl,
                        datatype: "json",
                        mtype: 'POST',
                        colNames: ['Id', 'Instance Id', 'Instance Name','Class Id','Class Name', 'Section Name', 'Short Name'],
                        colModel: [
                        ...
                        { name: 'ClassId', index: 'ClassId', width: 100, align: 'left', viewable: false, hidden: true, editable: true, formoptions: { elmsuffix: '(*)', rowpos: 4, colpos: 2 }, edittype: 'select', editrules: { required: true }, searchoptions: { sopt: ['eq', 'ne', 'cn']} },
                        { name: 'ClassName', index: 'ClassName', width: 100, align: 'left', editable: false, viewable: true, formoptions: { elmsuffix: '(*)', rowpos: 5, colpos: 2 }, edittype: 'text', editrules: { required: true }, searchoptions: { sopt: ['eq', 'ne', 'cn']} },
              { name: 'SectionName', index: 'SectionName', width: 100, align: 'left', editable: true, formoptions: { elmsuffix: '(*)', rowpos: 6, colpos: 2 }, edittype: 'text', editrules: { required: true }, searchoptions: { sopt: ['eq', 'ne', 'cn']} },
              { name: 'SectionShortName', index: 'SectionShortName', width: 100, align: 'left', editable: true, edittype: 'text', editrules: { required: true }, formoptions: { elmsuffix: '(*)', rowpos: 7, colpos: 2 }, searchoptions: { sopt: ['eq', 'ne', 'cn']}}],
                        rowNum: 10,
                        loadComplete: function () {
                            $("#list").setColProp('InstanceId', { editoptions: { value: countries} });
                            $("#list").setColProp('ClassId', { editoptions: { value: Classes} });
                        },
                        rowList: [10, 20, 30],
                        imgpath: gridimgpath,
                        height: 'auto',
   ...
   { closeOnEscape: true, url: "/Admin/EditJsonSection", closeAfterEdit: false, width: 350, checkOnSubmit: false, topinfo: "Transaction Successful..", bottominfo: "Fields marked with(*) are required.", beforeShowForm: function (form) { $("#tr_InstanceId").css("display", "block"); $("#tr_ClassId").css("display", "block"); }, afterSubmit: // Function for show msg after submit the form in edit
   ...
   {closeOnEscape: true, url: "/Admin/AddJsonSection", closeAfterAdd: false, width: 350, topinfo: "Transaction Successful..", bottominfo: "Fields marked with(*) are required.", beforeShowForm: function (formid) { $("#tr_InstanceId", formid).show(); $("#tr_ClassId", formid).show(); $("#FrmTinfo").css("display", "none"); }, afterSubmit: // Function for show msg after submit the form in Add
        function (response, postdata) {
            var json = response.responseText; //in my case response text form server is "{sc:true,msg:''}"
            if (json) {
                $("#FrmTinfo").css("display", "block");
   ...
   {url: "/Admin/DelJsonSection", onclickSubmit: function (params) {
       var ajaxData = {};
       var list = $("#list");
