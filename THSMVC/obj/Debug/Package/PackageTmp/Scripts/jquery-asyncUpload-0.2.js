    ...
    $.fn.makeAsyncUploader = function (options) {
        ...
        return this.each(function () {
            ...
            var defaults = {
                ...
                upload_url: "/Admin/AsyncNoticeUpload",
                ...
                upload_success_handler: function (file, response) {
                    ...
                    if (file.name == "Already Existed") {
                        ...
                        LoadDocumentPreview(response, file.size);
                        $("span[id$=_completedMessage]", container).html(" <input type='button' id='RemoveDocument' class='rg_button_red' onclick='RemoveDocument();' value='Remove File'></input>");
                    }
                    $("div.ProgressBar", container).hide();
