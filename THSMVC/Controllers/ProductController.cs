					...
					rows = (
						  ...
						  select new
						  {
							  ...
							  cell = new string[] {
								...
								s.ShortForm,
								s.ValueAddedByPerc.ToString()==string.Empty?"N/A":s.ValueAddedByPerc.ToString(),
								s.ValueAddedFixed.ToString()==string.Empty?"N/A":s.ValueAddedFixed.ToString(),
								s.MakingChargesPerGram.ToString()==string.Empty?"N/A":s.MakingChargesPerGram.ToString(),
								s.MakingChargesFixed.ToString()==string.Empty?"N/A":s.MakingChargesFixed.ToString(),
								s.IsStoneStr
                        }
						  }).ToArray()
				};
