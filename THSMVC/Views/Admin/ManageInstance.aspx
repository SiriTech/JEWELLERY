     ...
     <table id="list" class="scroll" cellpadding="0" cellspacing="0">
        ...
        <script defer="defer" type="text/javascript">
            ...
            jQuery("#list").jqGrid({
                ...
                datatype: "json",
                mtype: 'POST',
                colNames: ['ID', 'Instance Name', 'License From', 'License To'],
                colModel: [
              ...
              { name: 'InstanceName', index: 'InstanceName', width: 100, align: 'left', editable: true, formoptions: { elmsuffix: '(*)', rowpos: 2, colpos: 2} },
               { name: 'From', index: 'From', width: 100, align: 'left', editable: true, formoptions: { elmsuffix: '    ', rowpos: 3, colpos: 2} },
                { name: 'To', index: 'To', width: 100, align: 'left', editable: true, formoptions: { elmsuffix: '    ', rowpos: 4, colpos: 2}}],
                rowNum: 10,
                rowList: [10, 20, 30],
                imgpath: gridimgpath,
                height: 'auto',
