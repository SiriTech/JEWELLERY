        ...
        function LoadCustomers() {
            ...
            jQuery("#list").jqGrid({
                ...
                colModel: [
                  ...
                  { name: 'Customer Name', index: 'Name', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} },
                  { name: 'Customer Number', index: 'CustometNumber', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} },
                  { name: 'Address', index: 'Address', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} },
                  { name: 'City', index: 'City', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} },
                  { name: 'State', index: 'State', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} },
                  { name: 'Mobile', index: 'Mobile', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} },
                  { name: 'PhoneNumber', index: 'PhoneNumber', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} },
                  { name: 'EmailAddress', index: 'EmailAddress', align: 'left', hidedlg: true, hidden: false, editable: false, viewable: false, formoptions: { elmsuffix: '   ', rowpos: 1, colpos: 3} }
                ],
                rownumbers: true,
                rowNum: 10,
                rowList: [10, 20, 30],
